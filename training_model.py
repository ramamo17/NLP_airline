...
unlabeled_data = df[df.isnull().any(axis=1)]
...
data = {
    'avis': ['A1', 'A2', 'A3', 'A4', 'A5'],
    'cat1': [None, 'C1', 'C1', None, None],
    'cat2': ['C2', None, 'C2', None, None],
    'cat3': [None, None, None, None, None],
    'cat4': ['C4', 'C4', None, 'C4', None]
}
...
# Création du modèle de classification (par exemple, Multinomial Naive Bayes)
model = MultinomialNB()
